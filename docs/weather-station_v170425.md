...
- **Versão**: 170425
- **Data**: 17/04/2025
- **Descrição**: Atualização da Lista de Componentes com preços e dimensões do Abrigo Meteorológico (~€8-12, ~160 x 110 mm) e Caixa IP65 (~€5,19-8,50, ~65 x 95 x 55 mm internas, ~80 x 130 x 70 mm externas). Inclusão de controle de versão com requisitos, testes, e histórico. Cancelamento da função Direção do Vento mantido. Projeto otimizado para aquisição e montagem.
- **Autor**: Grok (xAI)
...
| **BME280** | Temperatura, Umidade, Pressão, Temperatura Aparente | 1 | 3-8 | AliExpress (busca: “BME280 module”) | I2C (0x76/0x77), 3,3 V, ±0,5°C, ±3%, ±1 hPa, IP65 com abrigo. |
...
| **Abrigo Meteorológico** | Temperatura, Umidade, Pressão, Temperatura Aparente | 1 | 8-12 | AliExpress ([link](https://nl.aliexpress.com/item/1005005459581452.html)) | Ventilado, IP65, evita exposição solar. Dimensões: \~160 mm (altura) x 110 mm (diâmetro). DIY (PVC/3D) viável. |
...
| **Caixa IP65 (Eletrônica)** | Gerenciamento de Energia, Qualidade do Ar, Velocidade do Vento | 1 | 5,19-8,50 | AliExpress ([link](https://nl.aliexpress.com/item/1005005691489549.html)) | Protege ESP32-C3, MT3608, RS485-TTL, PMS5003, INA219 (entrada de ar). Dimensões internas: \~65 x 95 x 55 mm; externas: \~80 x 130 x 70 mm. |
...
**Custo Total Estimado**: \~€83,68-162,86 (excluindo resistores, varia com frete/impostos).
